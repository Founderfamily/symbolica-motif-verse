...
UPDATE public.symbols 
SET tags = ARRAY['Or', 'Commerce', 'Proverbes', 'Afrique de l\'Ouest', 'Akan']
...
-- Boli
UPDATE public.symbols 
SET tags = ARRAY['Animisme', 'Rituel', 'Afrique de l\'Ouest', 'Société secrète', 'Bamana']
WHERE name = 'Boli';
...
WHERE name = 'Zibu' AND culture = 'Peuple Zapotèque (Mésoamérique)';