-- Diagnostic et correction de la migration des collections
-- Vérifier d'abord les collections actuelles puis créer les nouvelles

-- Supprimer d'abord les anciennes collections problématiques pour éviter les conflits
...
-- Maintenant créer les 20 nouvelles collections des grandes civilisations
...
-- Renommer la collection française existante
