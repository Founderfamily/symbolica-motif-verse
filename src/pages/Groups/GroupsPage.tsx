...
const GroupsPage: React.FC = () => {
  ...
  const searchPlaceholder = t('groups.searchPlaceholder');
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">
            <I18nText translationKey="groups.title" />
          </h1>
          <p className="text-sm sm:text-base text-slate-600 mt-1">
            <I18nText translationKey="groups.subtitle" />
          </p>
        </div>
        <Button 
        ...
        >
          ...
          <I18nText translationKey="groups.createNew" />
        </Button>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          <p className="text-slate-500">
            <I18nText translationKey="groups.noResults" />
          </p>
        </div>
      )}
    </div>
    ...
    >
      ...
      <CardFooter className="px-5 py-3 bg-slate-50 flex justify-between">
        <div className="flex items-center text-sm text-slate-600">
          <Users className="h-4 w-4 mr-1" /> {group.members_count} {membersText}
        </div>
        <div className="flex items-center text-sm text-slate-600">
          <Map className="h-4 w-4 mr-1" /> {group.discoveries_count} {discoveriesText}
        </div>
      </CardFooter>
    </Card>
  );
