...
export default function NewSymbolsManagement() {
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {((stats.verified_symbols / stats.total_symbols) * 100).toFixed(1)}%
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {((stats.symbols_with_images / stats.total_symbols) * 100).toFixed(1)}%
              </p>
            </CardContent>
          </Card>
