    ...
    Tables: {
      ...
      community_group_messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "community_group_messages_parent_message_id_fkey"
      ...
      quest_activities: {
        ...
        Relationships: [
          {
            foreignKeyName: "quest_activities_quest_id_fkey"
            columns: ["quest_id"]
            isOneToOne: false
            referencedRelation: "treasure_quests"
            referencedColumns: ["id"]
      ...
      quest_chat_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "quest_chat_messages_quest_id_fkey"
            columns: ["quest_id"]
            isOneToOne: false
            referencedRelation: "treasure_quests"
            referencedColumns: ["id"]
