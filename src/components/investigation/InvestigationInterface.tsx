    ...
    <ArchiveMapProvider>
      <div className="min-h-screen bg-gradient-to-br from-amber-50 to-slate-100">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="flex w-full flex-wrap justify-center md:justify-start bg-white/80 backdrop-blur-sm border border-amber-200 rounded-xl shadow-lg m-6 mb-0 p-1">
            <TabsTrigger 
              value="journal" 
