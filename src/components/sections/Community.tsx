    ...
    <section className="py-16 px-4 md:px-8 relative overflow-hidden bg-gradient-to-b from-white to-slate-50">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <span className="px-4 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-amber-100 to-amber-200 text-amber-800 inline-block mb-2">{t('sections.community')}</span>
          <h2 className="text-4xl font-bold mb-4 text-center bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">{t('community.title')}</h2>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 flex items-center">
                      ...
                      {group.members} {t('community.stats.members')}
                    </p>
                  </div>
                </div>
                <div className="flex justify-between text-sm items-center">
                  <span className="flex items-center gap-1 text-slate-600">
                    ...
                    {group.discoveries} {t('community.stats.discoveries')}
                  </span>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-6 rounded-xl border border-slate-200 shadow-md hover:shadow-lg transition-all">
            ...
            <h3 className="text-xl font-semibold mb-2">{t('community.features.thematicCommunities.title')}</h3>
            <p className="text-slate-600">{t('community.features.thematicCommunities.description')}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-6 rounded-xl border border-slate-200 shadow-md hover:shadow-lg transition-all">
            ...
            <h3 className="text-xl font-semibold mb-2">{t('community.features.personalSpace.title')}</h3>
            <p className="text-slate-600">{t('community.features.personalSpace.description')}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-6 rounded-xl border border-slate-200 shadow-md hover:shadow-lg transition-all">
            ...
            <h3 className="text-xl font-semibold mb-2">{t('community.features.intuitiveNavigation.title')}</h3>
            <p className="text-slate-600">{t('community.features.intuitiveNavigation.description')}</p>
          </div>
        </div>
      </div>
    </section>
