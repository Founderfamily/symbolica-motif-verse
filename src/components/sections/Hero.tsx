...
const Hero = () => {
  ...
  return (
    <section className="relative pt-20 md:pt-32 pb-20 md:pb-32 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      <div className="text-center relative z-10">
        <div className="inline-block p-2 bg-gradient-to-r from-amber-50 to-stone-50 rounded-full mb-12">
        ...
        <div className="space-y-8 mb-16">
          <h1 className="text-4xl md:text-7xl font-bold text-stone-800 font-adventure leading-tight">
            Symbol Explorer
          </h1>
