...
export const EmptyState: React.FC<EmptyStateProps> = ({ message }) => {
  return (
    <div className="flex items-center justify-center p-12 bg-gradient-to-br from-slate-50 to-slate-100 rounded-lg shadow-inner">
      <p className="text-slate-500 text-lg">{message || <I18nText translationKey="symbolTriptych.empty" />}</p>
    </div>
  );
};
  ...
  return (
    <div className="flex items-center justify-center p-12 bg-gradient-to-br from-slate-50 to-amber-50 rounded-lg animate-pulse">
      <div className="flex flex-col items-center">
        ...
        <p className="mt-4 text-amber-800"><I18nText translationKey="symbolTriptych.loading" /></p>
      </div>
    </div>
  );
};
...
export const ErrorState: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center p-12 bg-red-50 rounded-lg border border-red-100">
      ...
      <p className="text-slate-800 text-lg"><I18nText translationKey="symbolTriptych.error" /></p>
      <p className="text-slate-500"><I18nText translationKey="symbolTriptych.errorDesc" /></p>
    </div>
  );
};
